...
export const DEFAULT_GUEST_COMMANDS: readonly string[] = ['帮助', '状态', '回复', '停止', '全文']
 ...
 */
export const GUEST_TOOL_CATALOG: ReadonlyArray<{ pattern: string; label: string; risky: boolean }> = [
...
export const GUEST_COMMAND_CATALOG: ReadonlyArray<{ id: string; label: string }> = [
 ...
 */
export function matchesToolPattern(name: string, patterns: readonly string[]): boolean {
...
export function guestToolDenied(toolName: string): string {
