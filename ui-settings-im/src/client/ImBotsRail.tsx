/**
 * IM 机器人状态栏：挂在 shell.overlay 的顶部吸附行（右对齐）。
 *
 * 常驻形态 = 折叠横签（三个平台的图标 + 状态点，一眼可见）；点击展开成
 * Tab 化状态卡，从横签下方弹出——头部三平台 Tab（微信/飞书/企业微信），
 * 主体为选中平台的机器人本体行（账号 + 在线状态 + 绑定数）与绑定明细
 * 列表（Owner/访客、脱敏用户标识、绑定时间）。Tab 记住上次选中（组件内
 * 状态）。
 *
